...
async function flagActivity(flag,el){
  ...
  await executeOwnedAction('lookup','flag-document',async()=>{
    ...
    catch(e){ PendingQueue.enqueue({key:'DYNAMIC_ACTIONS',payload,ref:a.referenceId||String(a.id),error:e.message,operation:'flag-document'}); toast('Flag recorded; synchronization queued','error'); }
